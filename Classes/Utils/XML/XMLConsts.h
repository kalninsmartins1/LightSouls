...
namespace LightSouls
{
	...
	static constexpr char* XML_ENTITY_KNOCK_BACK_STRENGHT = "knockBackStrenght";
	...
	static constexpr char* XML_AI_IS_CHECKING_DISTANCE_TO_TARGET = "isCheckingDistanceToTarget";
